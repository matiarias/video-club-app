  ...
  return (
    <>
      <div className="relative w-[270px] sm:w-[280px] lg:w-[300px] inline-block cursor-pointer p-2 hover:scale-[1.05] transition ease-in-out delay-100">
        ...
        <p onClick={saveMovie}>
          {like ? (
            <FaHeart className="absolute top-4 left-4 text-indigo-600 text-2xl md:text-3xl" />
          ) : (
            <FaRegHeart className="absolute top-4 left-4 text-indigo-600 text-2xl md:text-3xl" />
          )}
        </p>
      </div>
    </>
